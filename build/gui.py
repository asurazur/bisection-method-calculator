...
from tkinter import Tk, Canvas, Entry, Text, Button, PhotoImage, font, StringVar, filedialog
...
def change_entry(char):
    ...
    if char not in "sin()cos()x()%^.*/+-" and focused_widget != entry_4:
        if focused_widget in (entry_1, entry_2):
...
def show_result(event=None):
    try:
        ...
        if (expression.is_valid()):
            ...
            txt = "Iterations for: \nf(x) = {},\t x_0 = {},\t x_1 = {}\n{}".format(
                equation.get(), guess1.get(), guess2.get(), iterations)
...
if __name__ == "__main__":
    ...
    window.iconbitmap(relative_to_assets("bisection_icon.ico"))
